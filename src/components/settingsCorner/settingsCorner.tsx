...
export default function SettingsCorner() {
	...
	return <form class="settings-corner" onSubmit={event => {
		...
		<span class="additional-settings-button" onClick={() => $settingsModalIsShown.set(!$settingsModalIsShown.get())}>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1.2rem">
				<path
		...
		<Show when={showModal()}>
			<dialog class="settings-modal" open>
				<div class="is-flex is-justify-content-end">
					<button type="button" class="close-button" onClick={() => $settingsModalIsShown.set(false)}>x</button>
				</div>
				<div class="field">
					...
					<p class="help">{t("tzpro_api_key_help")}&nbsp;<a
						href="https://github.com/lousando/briskett/wiki/Creating-a-TzPro-API-Key"
						target="_blank">https://github.com/lousando/briskett/wiki/Creating-a-TzPro-API-Key</a>
					</p>
				</div>
